    ...
    public void run(String... args) throws Exception {
        ...
        if(stateRepository.count() == 0) {
            ...
            Collections.addAll(stateList,
                    new State("Acre", BigDecimal.valueOf(0.03)),
                    new State("Alagoas", BigDecimal.valueOf(0.03)),
                    new State("Amazonas", BigDecimal.valueOf(0.03)),
                    new State("Amapá", BigDecimal.valueOf(0.03)),
                    new State("Bahia", BigDecimal.valueOf(0.03)),
                    new State("Ceará", BigDecimal.valueOf(0.03)),
                    new State("Distrito Federal", BigDecimal.valueOf(0.03)),
                    new State("Espírito Santo", BigDecimal.valueOf(0.03)),
                    new State("Goiás", BigDecimal.valueOf(0.03)),
                    new State("Maranhão", BigDecimal.valueOf(0.03)),
                    new State("Minas Gerais", BigDecimal.valueOf(0.03)),
                    new State("Mato Grosso do Sul", BigDecimal.valueOf(0.03)),
                    new State("Mato Grosso", BigDecimal.valueOf(0.03)),
                    new State("Pará", BigDecimal.valueOf(0.03)),
                    new State("Paraíba", BigDecimal.valueOf(0.03)),
                    new State("Pernambuco", BigDecimal.valueOf(0.03)),
                    new State("Piauí", BigDecimal.valueOf(0.03)),
                    new State("Paraná", BigDecimal.valueOf(0.03)),
                    new State("Rio de Janeiro", BigDecimal.valueOf(0.03)),
                    new State("Rio Grande do Norte", BigDecimal.valueOf(0.03)),
                    new State("Rondônia", BigDecimal.valueOf(0.03)),
                    new State("Roraima", BigDecimal.valueOf(0.03)),
                    new State("Rio Grande do Sul", BigDecimal.valueOf(0.03)),
                    new State("Santa Catarina", BigDecimal.valueOf(0.03)),
                    new State("Sergipe", BigDecimal.valueOf(0.03)),
                    new State("São Paulo", BigDecimal.valueOf(0.01)),
                    new State("Tocantins", BigDecimal.valueOf(0.03))
            );
        ...
        if(pricingGroupRepository.count() == 0) {
            ...
            Collections.addAll(pricingGroupList,
                    ...
                    new PricingGroup("Ferro", BigDecimal.valueOf(0.10)),
                    new PricingGroup("Bronze", BigDecimal.valueOf(0.05))
            );
